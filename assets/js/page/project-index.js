...
function loadClientTypePieChart(){
    const clientTypesData =  LoadClientTypeCounts()
   
    var chart = c3.generate({
        bindto: '#clientTypesPieChart', // id of chart wrapper
        data: {
            columns: [],
    ...
    setTimeout(function () {
        chart.load({
            columns: clientTypesData
        });
    }, 1500);
}

function areaDataTimeView(){
